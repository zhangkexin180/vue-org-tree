...
export const renderChildren = (h, list, context) => {
    if (Array.isArray(list) && list.length) {
        ...
        //add by ivy
        const { props } = context
        const cls = ['org-tree-node-children']
        let { childrenClassName } = props
        if (typeof childrenClassName === 'function') {
            childrenClassName = childrenClassName(list)
        }
        childrenClassName && cls.push(childrenClassName)
            //add end
